...
function serverLogic() {
  // Check if at least half a second has passed since the last update
  if (Date.now() - lastUpdateTime >= 500) {
    // Update positions in the database
    fetch('http://localhost:3000/update-positions', {
      method: 'POST',
      headers: {
    ...
    fetch('http://localhost:3000/update-game-data', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
